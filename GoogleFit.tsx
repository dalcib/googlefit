  ...
  return (
    <ScrollView style={{ backgroundColor: "#1f2026" }}>
      ...
      <View
        ...
        <View>
          <Text style={{ color: "#9a9ba1", fontSize: 40, fontWeight: "100" }}>|</Text>
        </View>
        <View>
      ...
      <View>
        <FitChart title="Sleep" description="7h 48m • Yesterday" data={sleepData} baseline={8} />
        <FitChart title="Take 10,000 steps a day" data={stepsData} baseline={10000} />
      </View>
      <View style={{ paddingLeft: 20, paddingRight: 20 }}>
        <AdditionalStats name="Heart rate" description="No recent data" />
        <AdditionalStats name="Weight" description="69 kg • Mar 14" />
        <AdditionalStats name="Blood pressure" description="120/70 mmHg • Apr 27, 2019" />
      </View>
    </ScrollView>
  );
};
